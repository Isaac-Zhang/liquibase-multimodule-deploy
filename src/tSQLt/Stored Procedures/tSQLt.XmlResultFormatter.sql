...
--changeSet proc:Initial-tSQLt-XmlResultFormatter-0 endDelimiter:\nGO splitStatements:true stripComments:false runOnChange:false
IF OBJECT_ID('tSQLt.XmlResultFormatter', 'P') IS NULL EXEC('CREATE PROCEDURE [tSQLt].[XmlResultFormatter]  AS BEGIN SELECT ret = 1 END')
GO



--changeSet proc:Initial-tSQLt-XmlResultFormatter-1 endDelimiter:\nGO splitStatements:true stripComments:false runOnChange:true
SET QUOTED_IDENTIFIER ON
GO
SET ANSI_NULLS ON
GO
ALTER PROCEDURE [tSQLt].[XmlResultFormatter]
AS
BEGIN
