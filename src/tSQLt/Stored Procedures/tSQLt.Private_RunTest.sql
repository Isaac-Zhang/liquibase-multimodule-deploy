...
--changeSet proc:Initial-tSQLt-Private_RunTest-0 endDelimiter:\nGO splitStatements:true stripComments:false runOnChange:false
IF OBJECT_ID('tSQLt.Private_RunTest', 'P') IS NULL EXEC('CREATE PROCEDURE [tSQLt].[Private_RunTest] @TestName nvarchar(MAX),@SetUp nvarchar(MAX) AS BEGIN SELECT ret = 1 END')
GO



--changeSet proc:Initial-tSQLt-Private_RunTest-1 endDelimiter:\nGO splitStatements:true stripComments:false runOnChange:true
