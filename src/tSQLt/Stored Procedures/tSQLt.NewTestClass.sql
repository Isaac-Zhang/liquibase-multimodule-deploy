...
--changeSet proc:Initial-tSQLt-NewTestClass-0 endDelimiter:\nGO splitStatements:true stripComments:false runOnChange:false
IF OBJECT_ID('tSQLt.NewTestClass', 'P') IS NULL EXEC('CREATE PROCEDURE [tSQLt].[NewTestClass] @ClassName nvarchar(MAX) AS BEGIN SELECT ret = 1 END')
GO



--changeSet proc:Initial-tSQLt-NewTestClass-1 endDelimiter:\nGO splitStatements:true stripComments:false runOnChange:true
