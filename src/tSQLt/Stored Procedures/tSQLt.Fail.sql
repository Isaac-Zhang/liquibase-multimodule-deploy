...
--changeSet proc:Initial-tSQLt-Fail-0 endDelimiter:\nGO splitStatements:true stripComments:false runOnChange:false
IF OBJECT_ID('tSQLt.Fail', 'P') IS NULL EXEC('CREATE PROCEDURE [tSQLt].[Fail] @Message0 nvarchar(MAX),@Message1 nvarchar(MAX),@Message2 nvarchar(MAX),@Message3 nvarchar(MAX),@Message4 nvarchar(MAX),@Message5 nvarchar(MAX),@Message6 nvarchar(MAX),@Message7 nvarchar(MAX),@Message8 nvarchar(MAX),@Message9 nvarchar(MAX) AS BEGIN SELECT ret = 1 END')
GO



--changeSet proc:Initial-tSQLt-Fail-1 endDelimiter:\nGO splitStatements:true stripComments:false runOnChange:true
