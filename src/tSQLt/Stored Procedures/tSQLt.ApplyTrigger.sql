...
--changeSet proc:Initial-tSQLt-ApplyTrigger-0 endDelimiter:\nGO splitStatements:true stripComments:false runOnChange:false
IF OBJECT_ID('tSQLt.ApplyTrigger', 'P') IS NULL EXEC('CREATE PROCEDURE [tSQLt].[ApplyTrigger] @TableName nvarchar(MAX),@TriggerName nvarchar(MAX) AS BEGIN SELECT ret = 1 END')
GO



--changeSet proc:Initial-tSQLt-ApplyTrigger-1 endDelimiter:\nGO splitStatements:true stripComments:false runOnChange:true
