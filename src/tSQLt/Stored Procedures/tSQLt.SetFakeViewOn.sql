...
--changeSet proc:Initial-tSQLt-SetFakeViewOn-0 endDelimiter:\nGO splitStatements:true stripComments:false runOnChange:false
IF OBJECT_ID('tSQLt.SetFakeViewOn', 'P') IS NULL EXEC('CREATE PROCEDURE [tSQLt].[SetFakeViewOn] @SchemaName nvarchar(MAX) AS BEGIN SELECT ret = 1 END')
GO



--changeSet proc:Initial-tSQLt-SetFakeViewOn-1 endDelimiter:\nGO splitStatements:true stripComments:false runOnChange:true
